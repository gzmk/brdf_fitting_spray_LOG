...
writetable(T,'/scratch/gk925/brdf_fitting_spray_LOG/gloss20_fit/sphere_3params_Conditions.txt','Delimiter','\t')
%% Rendering bit

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/brdf_fitting_spray_LOG/gloss20_fit');
...
mappingsFile = '20gloss_DefaultMappings.txt';
...
imPath = ['/scratch/gk925/brdf_fitting_spray_LOG/gloss20_fit/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
...
mask = zeros(1005,668);
mask(382:574,256:460)=1;

load('registered20.mat') % make this a variable
