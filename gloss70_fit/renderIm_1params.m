...
writetable(T,'/scratch/gk925/brdf_fitting_spray_LOG/gloss70_fit/sphere_3params_Conditions.txt','Delimiter','\t')
%% Rendering bit

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/brdf_fitting_spray_LOG/gloss70_fit');
...
mappingsFile = '70gloss_DefaultMappings.txt';
...
imPath = ['/scratch/gk925/brdf_fitting_spray_LOG/gloss70_fit/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
...
mask = zeros(1005,668);
mask(375:585,256:444)=1;

load('registered70.mat') % make this a variable
