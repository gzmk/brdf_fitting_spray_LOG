...
writetable(T,'/scratch/gk925/brdf_fitting_spray_LOG/gloss60_fit/sphere_3params_Conditions.txt','Delimiter','\t')
%% Rendering bit

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/brdf_fitting_spray_LOG/gloss60_fit');
...
mappingsFile = '60gloss_DefaultMappings.txt';
...
imPath = ['/scratch/gk925/brdf_fitting_spray_LOG/gloss60_fit/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
...
load('registered60.mat') % make this a variable
