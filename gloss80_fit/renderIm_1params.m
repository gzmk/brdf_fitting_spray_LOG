...
writetable(T,'/scratch/gk925/brdf_fitting_spray_LOG_LOG/better_gloss80_fit/sphere_3params_Conditions.txt','Delimiter','\t')
%% Rendering bit

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/brdf_fitting_spray_LOG_LOG/better_gloss80_fit');
...
mappingsFile = '80v2gloss_DefaultMappings.txt';
...
imPath = ['/scratch/gk925/brdf_fitting_spray_LOG_LOG/better_gloss80_fit/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
...
load('registered80v2.mat') % make this a variable
